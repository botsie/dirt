...
Dirt uses the ["Chronic":https://github.com/mojombo/chronic] gem to parse these description. See 
["Chronic's examples":https://github.com/mojombo/chronic#examples] for a complete listing.
